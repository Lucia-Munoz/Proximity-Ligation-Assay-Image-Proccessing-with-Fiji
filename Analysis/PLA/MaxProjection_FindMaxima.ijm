...
//      subcarpeta "find maxima", con el mismo nombre + " Maxima.tif".
//
// Uso:
...
// Paso 3: reabrir las proyecciones guardadas y aplicar Find Maxima
output_dir = outputDir + "find maxima" + File.separator;
...
for (i = 0; i < projFiles.length; i++) {
    ...
    // Cerramos la imagen de maximos y la proyeccion original
...
showMessage("Listo",
    ...
    "\n\nResultados de Find Maxima guardados en:\n" + output_dir);
